...
class ExchangeCache:
    ...
    def get_slim_data(self, ex_id, logger):
        ...
        try:
            ...
            # Strip markets and currencies immediately after loading.
            # This frees ~7-11MB per exchange that would otherwise sit
            # in RAM for the entire duration of the scan.
